...
<head>
    ...
    <title>@yield('title', 'Admin Dashboard') - {{ config('app.name', 'Robertson Buses') }}</title>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="{{ route('admin.checklists.index') }}" class="{{ request()->routeIs('admin.checklists.*') ? 'active' : '' }}">
